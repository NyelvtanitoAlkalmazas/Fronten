    ...
    <div>
      {tasks.length && currentTaskId < 7 ? (
        <>
          ...
          <select onChange={handleSelectAnswer} value={taskState.selectValue}>
          ...
          <button onClick={handleClickNext} disabled={taskState.isDisabled}>
            Következő!
          </button>
        </>
      ) : (
...
export default CurrentChooseTask;
